      ...
      <div className='w-11/12 lg:w-2/3 flex flex-wrap items-center justify-center gap-4 p-4'>
        ...
        {jobApplications.length > 0 ? (
          jobApplications.map((application, index) => (
            <div key={index} onClick={() => { setCurApp(application), handleopenEdit() }} className='w-11/12 sm:w-5/12 flex flex-col items-start justify-start gap-3 p-4 bg-vnbg shadow-md rounded-lg hover:shadow-lg transition duration-300'>
